...
import { Tag, PlusCircle, RocketLaunch, CaretLeft } from '@phosphor-icons/react';
          ...
          <form onSubmit={salvarTema} className="space-y-8">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <PlusCircle size={20} className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-600" />
                <input 
                  type="text"
                  name="descricao"
                  required
            ...
            <button 
              type="submit"
              disabled={carregando}
              className="w-full group relative flex items-center justify-center rounded-2xl bg-gradient-to-r from-fuchsia-600 to-violet-700 px-8 py-5 text-white font-black uppercase tracking-tighter transition-all hover:shadow-[0_0_40px_rgba(192,38,211,0.4)] hover:scale-[1.01] active:scale-95 disabled:opacity-50"
            >
