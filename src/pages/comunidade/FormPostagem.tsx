...
import { 
  PaperPlaneTilt, Tag, TextT, 
  ChatCircleDots, CaretLeft 
    ...
    <div className="min-h-screen bg-slate-950 pt-28 pb-12 px-4 relative overflow-hidden text-slate-300">
      ...
      <div className="mx-auto max-w-3xl">
        <div className="bg-slate-900/40 backdrop-blur-3xl border border-white/5 p-8 md:p-12 rounded-[40px] shadow-2xl relative overflow-hidden">
          ...
          >
            <CaretLeft size={16} /> Abortar_Envio
          </button>
          ...
          <form onSubmit={salvarPostagem} className="space-y-8">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <TextT size={20} className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-600" />
                <input 
                  type="text"
                  name="titulo"
                  required
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Tag size={20} className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-600" />
                <select 
            ...
            <div className="space-y-2">
              ...
              <textarea 
                ...
                className="w-full bg-slate-950/60 border border-white/5 rounded-[32px] px-8 py-6 text-slate-200 focus:outline-none focus:border-violet-500/50 transition-all font-mono text-sm resize-none leading-relaxed"
