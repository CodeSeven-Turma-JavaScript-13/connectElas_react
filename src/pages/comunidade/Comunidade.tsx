...
function InterfacePreview() {
  return (
    ...
    <div className="relative aspect-[16/9] w-full overflow-hidden rounded-xl border border-[#521f68]/45 bg-[#0b0d1a] shadow-[0_30px_90px_-35px_rgba(82,31,104,0.78)]">
      <img
      ...
      <div className="absolute inset-x-0 h-28 animate-pulse bg-gradient-to-b from-transparent via-[#521f68]/70 to-transparent" />
...
export default function Comunidade() {
  return (
    ...
    <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-[#020617] px-6 py-10 text-white">
      ...
      <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.02)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.02)_1px,transparent_1px),radial-gradient(circle_at_50%_0%,rgba(82,31,104,0.15),transparent_60%)] bg-[length:54px_54px,54px_54px,100%_100%] opacity-70" />
      ...
      <section className="relative z-10 flex w-full max-w-5xl flex-col items-center">
        ...
        <h1 className="max-w-4xl text-center font-['Arial_Black','Arial',sans-serif] text-5xl font-black uppercase italic tracking-normal text-white md:text-7xl">
          Nossa <span className="bg-gradient-to-r from-[#521f68] to-[#a855f7] bg-clip-text text-transparent pr-6" >Comunidade</span>
        </h1>
