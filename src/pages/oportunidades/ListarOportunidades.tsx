...
import { MagnifyingGlass, Funnel, PlusCircle } from '@phosphor-icons/react';
...
function ListarOportunidades() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 pt-24 pb-12 px-4 relative overflow-hidden">
      {/* Background Glow */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[800px] h-[600px] bg-fuchsia-600/5 rounded-full blur-[150px] -z-10"></div>
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
          <div>
            <h1 className="text-4xl md:text-5xl font-black text-white tracking-tighter uppercase italic">
              Vagas <span className="bg-gradient-to-r from-fuchsia-400 to-violet-400 bg-clip-text text-transparent">Tech Selecionadas</span>
            </h1>
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-12">
          <div className="flex-1 relative">
            <MagnifyingGlass size={20} className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-600" />
            <input 
              type="text" 
          ...
          {oportunidadesFiltradas.length > 0 ? (
            ...
            <div className="col-span-full py-20 text-center">
              <div className="h-20 w-20 bg-slate-900 rounded-full flex items-center justify-center mx-auto mb-6 border border-white/5">
                <MagnifyingGlass size={32} className="text-slate-700" />
              </div>
