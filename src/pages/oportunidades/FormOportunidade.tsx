...
import { 
  PlusCircle, Buildings, MapPin, CurrencyDollar, 
  Briefcase, CheckCircle, RocketLaunch 
...
function FormOportunidade() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 pt-24 pb-12 px-4 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 right-0 w-[500px] h-[500px] bg-fuchsia-600/5 rounded-full blur-[150px] -z-10"></div>
      
      <div className="mx-auto max-w-4xl">
        <div className="bg-slate-900/40 backdrop-blur-3xl border border-white/5 rounded-[40px] p-8 md:p-12 shadow-2xl relative">
          
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-48 h-1 bg-gradient-to-r from-transparent via-fuchsia-500 to-transparent"></div>

          <div className="text-center mb-12">
            <div className="h-16 w-16 bg-gradient-to-br from-fuchsia-600 to-violet-700 rounded-2xl flex items-center justify-center text-white mx-auto mb-4 shadow-[0_0_30px_rgba(192,38,211,0.3)]">
              <PlusCircle size={36} weight="bold" />
            </div>
          ...
          <form onSubmit={gerarNovaVaga} className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Briefcase size={20} className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-600" />
                  <input
                    type="text"
                    name="titulo"
                    required
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Buildings size={20} className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-600" />
                  <input
                    type="text"
                    name="empresa"
                    required
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <div className="relative">
                  <MapPin size={20} className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-600" />
                  <input
                    type="text"
                    name="localizacao"
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <CurrencyDollar size={20} className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-600" />
                  <input
                    type="text"
                    name="salario"
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                className="w-full bg-slate-950/60 border border-white/5 rounded-[24px] px-6 py-4 text-slate-200 focus:outline-none focus:border-fuchsia-500/50 transition-all font-mono text-sm resize-none"
            ...
            <div className="flex flex-col md:flex-row gap-4 pt-8">
              ...
              >
                ...
                <RocketLaunch size={24} weight="bold" className="ml-3 transition-transform group-hover:translate-x-1" />
              </button>
            </div>
          ...
          <div className="mt-12 pt-6 border-t border-white/5 flex justify-between items-center text-[8px] font-mono text-slate-700 uppercase tracking-[0.3em]">
             <span className="flex items-center gap-2 italic"><CheckCircle size={10} /> SYSTEM_READY</span>
