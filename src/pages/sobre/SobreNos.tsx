...
import { RocketLaunch, Heart, Users, Globe, Target, AppWindow } from '@phosphor-icons/react';
...
function SobreNos() {
  return (
    <div className="min-h-screen bg-slate-950 pt-28 pb-12 px-4 relative overflow-hidden text-slate-300">
      ...
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-fuchsia-600/5 rounded-full blur-[150px] -z-10 animate-pulse"></div>
      <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-violet-600/5 rounded-full blur-[150px] -z-10"></div>

      <div className="mx-auto max-w-6xl">
        
        {/* Hero Section */}
        <div className="text-center mb-24 relative">
          <div className="mb-6 inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-fuchsia-600 to-violet-700 text-white shadow-[0_0_30px_rgba(192,38,211,0.4)]">
             <RocketLaunch size={36} weight="bold" />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-32">
          ...
          <div className="relative group">
             <div className="absolute -inset-1 bg-gradient-to-r from-fuchsia-600 to-violet-600 rounded-[40px] blur opacity-25 group-hover:opacity-50 transition duration-1000"></div>
             <div className="relative bg-slate-900 border border-white/5 rounded-[40px] p-12 overflow-hidden flex items-center justify-center min-h-[400px]">
                <Globe size={120} weight="thin" className="text-fuchsia-500/20 animate-[spin_20s_linear_infinite]" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-32">
          {[
            { icon: <Users size={32} />, title: "Sororidade", desc: "Apoio mútuo como base para o crescimento profissional." },
            { icon: <Target size={32} />, title: "Inovação", desc: "Buscamos o estado da arte em tudo o que construímos." },
            { icon: <Heart size={32} />, title: "Paixão", desc: "Amamos o que fazemos e a comunidade que servimos." }
          ].map((item, idx) => (
            <div key={idx} className="bg-slate-900/40 backdrop-blur-2xl border border-white/5 p-10 rounded-[32px] hover:border-fuchsia-500/30 transition-all group">
        ...
        {/* Chamada para Ação */}
        <div className="bg-gradient-to-br from-violet-600 to-fuchsia-700 rounded-[50px] p-12 md:p-24 text-center relative overflow-hidden">
