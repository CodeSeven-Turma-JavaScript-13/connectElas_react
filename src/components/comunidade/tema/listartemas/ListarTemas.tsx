...
import { CaretLeftIcon, TerminalIcon, PlusCircleIcon, TagIcon, PencilIcon, TrashIcon } from '@phosphor-icons/react';
...
function ListarTemas() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 pt-28 pb-12 px-4 relative overflow-hidden text-slate-300">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-200 h-100 bg-violet-600/5 rounded-full blur-[150px] -z-10"></div>
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-12">
          <div className="max-w-2xl">
            ...
            >
              <CaretLeftIcon size={16} /> Voltar_Feed
            </button>
        ...
        <div className="space-y-4">
          {carregando ? (
            ...
            <div className="py-32 text-center bg-slate-900/20 border border-dashed border-white/10 rounded-[40px]">
              <TagIcon size={48} className="mx-auto text-slate-800 mb-6" />
