...
import { FunnelIcon, LightningIcon, MagnifyingGlassIcon, PlusCircleIcon, TagIcon, TerminalIcon, UsersIcon } from '@phosphor-icons/react';
...
function ListarPostagens() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 pt-28 pb-12 px-4 relative overflow-hidden text-slate-300">
      ...
      <div className="absolute top-0 right-1/2 translate-x-1/2 w-150 h-150 bg-fuchsia-600/5 rounded-full blur-[150px] -z-10"></div>
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-slate-500 font-mono text-xs uppercase tracking-[0.3em] flex items-center gap-2">
              <TerminalIcon size={16} className="text-fuchsia-400" />
          ...
          <div className="flex gap-4">
            <Link 
              to="/temas"
              className="inline-flex items-center gap-3 bg-slate-900 border border-white/10 text-white px-8 py-5 rounded-3xl font-black uppercase tracking-tighter hover:bg-white/5 transition-all active:scale-95 whitespace-nowrap"
            >
            ...
            <Link 
              ...
              className="inline-flex items-center gap-3 bg-white text-slate-950 px-8 py-5 rounded-3xl font-black uppercase tracking-tighter hover:bg-fuchsia-500 hover:text-white hover:shadow-[0_0_40px_rgba(217,70,239,0.3)] transition-all active:scale-95 whitespace-nowrap"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1 space-y-8">
            <div className="bg-slate-900/40 backdrop-blur-3xl border border-white/5 p-8 rounded-4xl">
              <h3 className="text-white font-black uppercase tracking-widest text-[10px] mb-6 flex items-center gap-2">
                <FunnelIcon size={16} className="text-fuchsia-500" />
                Explorar_Tópicos
              </h3>
            ...
            <div className="bg-linear-to-br from-violet-600/20 to-fuchsia-600/20 border border-white/10 p-8 rounded-4xl">
               <LightningIcon size={32} className="text-white mb-4" />
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="relative group">
              <MagnifyingGlassIcon size={20} className="absolute left-6 top-1/2 -translate-y-1/2 text-slate-600 group-focus-within:text-fuchsia-400 transition-colors" />
              <input 
                type="text" 
                placeholder="PROCURAR_POSTAGENS..."
                className="w-full bg-slate-900/40 border border-white/5 rounded-3xl pl-16 pr-8 py-5 text-slate-300 font-mono text-xs uppercase tracking-widest focus:outline-none focus:border-fuchsia-500/30 transition-all shadow-xl"
              />
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {postagens.length > 0 ? (
                  ...
                  <div className="col-span-2 py-40 text-center bg-slate-900/20 border border-dashed border-white/10 rounded-[40px]">
                    <UsersIcon size={48} className="mx-auto text-slate-800 mb-6" />
