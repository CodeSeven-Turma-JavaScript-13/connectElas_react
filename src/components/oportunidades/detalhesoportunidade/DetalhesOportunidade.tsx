...
function DetalhesOportunidade() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 pt-24 pb-12 px-4 relative overflow-hidden">
      {/* Background Glow */}
      <div className="absolute top-1/4 left-1/4 w-150 h-150 bg-fuchsia-600/5 rounded-full blur-[150px] -z-10 pointer-events-none"></div>
      <div className="absolute bottom-1/4 right-1/4 w-150 h-150 bg-violet-600/5 rounded-full blur-[150px] -z-10 pointer-events-none"></div>
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            {/* Header da Vaga */}
            <div className="bg-slate-900/40 backdrop-blur-2xl border border-white/5 p-8 rounded-4xl">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 py-6 border-y border-white/5">
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-white flex items-center gap-1.5"><MapPinIcon size={14} className="text-violet-500" /> {oportunidade.localizacao}</p>
                </div>
                <div className="space-y-1">
                  <p className="text-[9px] text-slate-500 font-black uppercase">Tipo</p>
                  <p className="text-xs text-white flex items-center gap-1.5"><BriefcaseIcon size={14} className="text-violet-500" /> {oportunidade.tipoContrato}</p>
                </div>
                <div className="space-y-1">
                  <p className="text-[9px] text-slate-500 font-black uppercase">Nível</p>
                  <p className="text-xs text-white flex items-center gap-1.5"><CalendarIcon size={14} className="text-violet-500" /> {oportunidade.nivelExperiencia}</p>
                </div>
                <div className="space-y-1">
                  <p className="text-[9px] text-slate-500 font-black uppercase">Remuneração</p>
                  <p className="text-xs text-white flex items-center gap-1.5"><CurrencyDollarIcon size={14} className="text-violet-500" /> {oportunidade.salario}</p>
                </div>
              </div>

              <div className="mt-8">
                <h3 className="text-white font-bold uppercase tracking-widest text-[11px] mb-4 flex items-center gap-2">
                  <InfoIcon size={16} className="text-fuchsia-500" />
            ...
            <div className="bg-slate-900/40 backdrop-blur-2xl border border-white/5 p-8 rounded-4xl">
              <h3 className="text-white font-bold uppercase tracking-widest text-[11px] mb-6 flex items-center gap-2">
                <CheckCircleIcon size={18} className="text-fuchsia-500" />
          ...
          <div className="space-y-6 relative z-20">
            <div className="bg-slate-900/60 backdrop-blur-2xl border border-white/10 p-8 rounded-4xl sticky top-24">
