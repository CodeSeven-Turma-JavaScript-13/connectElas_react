        ...
        <div className="bg-slate-900/40 backdrop-blur-3xl border border-white/5 p-8 md:p-12 rounded-[40px] shadow-2xl relative overflow-hidden">
          ...
          <div className="text-center mb-10">
            <div className="inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-linear-to-br from-fuchsia-600 to-violet-700 text-white font-mono font-black mb-4 shadow-[0_0_30px_rgba(192,38,211,0.3)]">
              <PaperPlaneTiltIcon size={32} weight="bold" />
            </div>
          ...
          <form onSubmit={submeterCandidatura} className="space-y-8">
            ...
            <div className="space-y-6">
              <h3 className="text-white font-bold uppercase tracking-widest text-[10px] flex items-center gap-2">
                <IdentificationCardIcon size={18} className="text-fuchsia-500" />
            ...
            <div className="space-y-6">
              <h3 className="text-white font-bold uppercase tracking-widest text-[10px] flex items-center gap-2">
                <LinkSimpleIcon size={18} className="text-fuchsia-500" />
                NODES_DIGITAIS
              </h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <LinkedinLogoIcon size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-600" />
                    <input
                      type="url"
                      name="linkedin"
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <CodeIcon size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-600" />
                    <input
                      type="url"
                      name="portfolio"
            ...
            <div className="space-y-6">
              <h3 className="text-white font-bold uppercase tracking-widest text-[10px] flex items-center gap-2">
                <MoneyIcon size={18} className="text-fuchsia-500" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <ClockIcon size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-600" />
                    <select
