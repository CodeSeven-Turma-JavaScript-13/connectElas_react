    ...
    <nav className="sticky top-0 z-50 w-full border-b border-fuchsia-500/20 bg-slate-950/90 backdrop-blur-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between p-4">
        ...
        <Link to="/home" className="flex items-center gap-2 group cursor-pointer">
          <div className="h-9 w-9 rounded-lg bg-gradient-to-tr from-fuchsia-600 to-violet-600 flex items-center justify-center text-white font-mono font-bold shadow-[0_0_20px_rgba(192,38,211,0.4)] group-hover:scale-110 transition-transform">
            &lt;E&gt;
          </div>
        ...
        <div className="flex items-center gap-4">
          {!estaLogado ? (
            <Link 
              to="/login"
              className="rounded-full bg-gradient-to-r from-fuchsia-600 to-violet-600 px-6 py-2 text-xs font-bold text-white shadow-lg hover:shadow-fuchsia-500/40 transition-all active:scale-95"
            >
              ÁREA DA DEV
            </Link>
          ) : (
